...
df_goalscores = pd.read_csv('BDA_project/bd_dataset/goalscorers.csv')
...
df_shootouts = pd.read_csv('BDA_project/bd_dataset/goalscorers.csv')
...
df_results = pd.read_csv('BDA_project/bd_dataset/results.csv')
